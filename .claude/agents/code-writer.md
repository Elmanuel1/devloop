...
| Before writing code — check for duplication | `.claude/skills/dry-patterns/SKILL.md` |
| Before writing tests — make code testable | `.claude/skills/testability/SKILL.md` |
...
| Self-check before opening PR | `.claude/skills/refactoring-checklist/SKILL.md` |
...
1. Read `.claude/skills/dry-patterns/SKILL.md` — check for existing shared logic
