...
/**
 * Repository for integration accounts operations.
...
public interface IntegrationAccountRepository {
    ...
    /**
     * Find all accounts for a company (across all connections).
     *
     * @param companyId company ID
     * @param accountType filter by account type (EXPENSE for expense accounts only, null for all accounts)
     * @return list of accounts
     */
    List<IntegrationAccount> findByCompanyId(Long companyId, AccountType accountType);
