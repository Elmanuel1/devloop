...
/**
 * Repository for purchase order sync operations.
 * Used for syncing purchase orders from external providers.
 */
public interface PurchaseOrderSyncRepository {

    /**
     * Upsert purchase orders from provider.
     * Creates new POs or updates existing ones based on company_id + provider +
     * external_id.
     * Provider is read from each PurchaseOrder's provider field.
     * Also handles upserting line items in a transaction.
     *
     * @param companyId      company ID
     * @param purchaseOrders list of purchase orders to upsert (must have provider
     *                       set)
     */
     ...
     * Deletes POs where company_id, provider, and external_id match.
     *
     * @param companyId   company ID
     ...
     *
     * @param companyId  company ID
     * @param displayIds list of display IDs
