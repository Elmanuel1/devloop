...
/**
 * Infrastructure component that provides Redisson distributed locks for the
 * extraction pipeline.
 *
 * <h3>Lock levels</h3>
 * <ul>
 ...
 *
 * <p>This is an infrastructure component ({@code @Component}), not a business
 * service. It is a thin wrapper around {@link RedissonClient} that encapsulates
 * lock-key construction, lease configuration, and safe unlock semantics.
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class ExtractionLockManager {
