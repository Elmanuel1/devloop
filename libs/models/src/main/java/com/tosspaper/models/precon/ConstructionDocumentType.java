 ...
 *
 * <p>This enum implements {@link TenderDocumentType} so that callers depend only on
 * the base interface and can be extended to other procurement domains without
 * changing the classifier contract.
 *
