...
/**
 * Service for contact/vendor sync operations.
...
public interface ContactSyncService {
     ...
     * @param contacts list of contacts to upsert
     */
    ...
    /**
     * Batch update sync status for multiple contacts after successful push to provider.
     * More efficient than calling updateSyncStatus multiple times.
     *
     * @param updates list of sync status updates
     */
    void batchUpdateSyncStatus(java.util.List<com.tosspaper.models.common.SyncStatusUpdate> updates);
